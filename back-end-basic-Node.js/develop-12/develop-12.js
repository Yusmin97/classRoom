 ...
 * http 중에서 대표적인 '서버를 만드는' 메서드 createServer를
 * 아래에 사용했다.
 * createServer는 하나의 매개변수만 요구하며,
 * 그 하나의 매개변수는 콜백함수 방식을 원한다.
 * 콜백함수는 두개의 매개변수를 처리할 수 있다.
 * 
 * 위 사항을 외우는 것은(자주 사용하여 외어지는 일은 흔해도)
 * 큰 문제가 될 수 있다.(계속 업데이트 하기 때문)
 * 
 */

http.createServer(function(request, response) {
  // create의 콜백함수 첫번째 매개변수로 명명한 request가
  // 무엇을 주는지 확인한다.
   ...
   * index.html 파일을 콜백함수로 읽어들인 것을 '응답 데이터'로
   * 활용한 예시이다.
   * 
   */
