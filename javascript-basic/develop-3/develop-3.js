 ...
 * 소괄호에 마치 "@media (max-width:600px)" 처럼 작성되어 있는 것에 주목하시기 바랍니다.
 */
const mediaQuery = `(max-width: ${mediaQuery}px)`;

// 아래의 함수는 최소기능만 작동하게끔 직접 만든 함수이므로 개발자의 함수(사용자정의 함수)입니다.
// 함수를 '선언' 했을 뿐 호출 될 때까지 전혀 실행되지 않는 다는 점이 주요 관점입니다.
